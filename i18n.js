...
function rebuild(){const b=locale==='zh-CN'?{map:{},pattern:null}:bundle(locale);phrases=b.map;pattern=b.pattern;revision++;}
...
function observe(){if(locale!=='zh-CN')observer?.observe(document.body,{subtree:true,childList:true,characterData:true,attributes:true,attributeFilter:attrNames})}
