...
> **下载请认准 [imfishman.com](https://imfishman.com/)。** 第二个公开测试版 **0.1.2-rc.1** 已发布：[选择版本并下载](https://imfishman.com/download) · [GitHub Release](https://github.com/TDGOTT-K/EVE-FitLab/releases/tag/v0.1.2-rc.1)。这是测试版，尚未代码签名，可能存在问题；重要装配请保留备份。
