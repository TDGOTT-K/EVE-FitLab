...
class NativeCurves(unittest.TestCase):
    ...
    def test_ideal_and_edps_public_full_result_parity(self):
        b=bridge();import jsonschema
        schema=json.loads((b.root/b.baseline['contractDirectory']/'output-schemas.json').read_text(encoding='utf-8'))['schemas']['fit_output_curves']
