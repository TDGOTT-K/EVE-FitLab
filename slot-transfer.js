export function transferSlots(slots,sourceKey,targetKey,ammo,compatible){
 ...
 if(ammo){[a.ammo,b.ammo]=[b.ammo||null,a.ammo];const ac=a.loadedCharges,bc=b.loadedCharges;delete a.loadedCharges;delete b.loadedCharges;if(bc!==undefined)a.loadedCharges=bc;if(ac!==undefined)b.loadedCharges=ac;}
 else{
