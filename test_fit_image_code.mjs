...
// Share payloads preserve explicit state; current engine admission decides whether it is valid.
...
for(const encode of [encodeFitCodes,encodeLegacyFitCodes]){
 ...
 assert.equal(imported.slots[0].state,'Active');
...
console.log('Explicit state: legacy/modern image roundtrip and offline preservation passed');
