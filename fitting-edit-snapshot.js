...
const fields=['name','notes','tags','skills','characterName','fighterLoadout','fighterUiMock','outputMetric','loadoutPlan','implantPlan','tacticalModeTypeId','drones','cargo','crystals'];
