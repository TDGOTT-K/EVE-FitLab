...
> The fifth public test release **0.1.2-rc.4** is available. [Choose a version](https://imfishman.com/download) or [view the release](https://github.com/TDGOTT-K/EVE-FitLab/releases/tag/v0.1.2-rc.4). This is an unsigned test release; keep backups of important fits.
